    ...
    */
    ...
    'connections' => [
        ...
        'account' => [
            ...
            'username' => env('DB_ACCOUNT_USERNAME', 'forge'),
        ...
        'soal' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_SOAL_HOST', '127.0.0.1'),
            'port' => env('DB_SOAL_PORT', '3306'),
            'database' => env('DB_SOAL_DATABASE', 'forge'),
            'username' => env('DB_SOAL_USERNAME', 'forge'),
            'password' => env('DB_SOAL_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
