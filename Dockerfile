...
RUN chmod -Rcvf 775 /var/www/html/

RUN mkdir -p /var/www/html/storage/logs && chmod 777 /var/www/html/storage -R
RUN mkdir -p /var/log/BACKENDLARAVELSSO/v1 && chmod 777 /var/log/BACKENDLARAVELSSO/v1 -R
